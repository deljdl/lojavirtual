                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img class="img-responsive" src="assets/images/product-image/1.jpg" alt="Compare Product" /></a>
                                            <a href="#" class="category">Table</a>
                                            <a href="#" class="title">Office Furniture Table</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img class="img-responsive" src="assets/images/product-image/2.jpg" alt="Compare Product" /></a>
                                            <a href="#" class="category">Chair</a>
                                            <a href="#" class="title">Office Furniture Table</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img class="img-responsive" src="assets/images/product-image/3.jpg" alt="Compare Product" /></a>
                                            <a href="#" class="category">Sofa</a>
                                            <a href="#" class="title">Office Furniture Table</a>
                                        </td>
                                    </tr>
                                    <tr>
